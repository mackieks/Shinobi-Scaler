...
**Update (10/30/22):** The above source for ESP-06s has disappeared (perhaps someone cleaned out their stock?) I may refactor the design to use a different ESP8266 module or list my stock of ESP06s on eBay if another seller doesn't fill the void.
